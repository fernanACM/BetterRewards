...
class FridayInventoryManager extends InventoryManager{
    ...
    public static function saveFridayInventory(): void{
        ...
        $menu = FridayInventoryManager::getContents();
        $place = [];
     ...
     * @return void
     */
    public static function loadFridayInventory(): void{
        $inv = new Config(Loader::getInstance()->getDataFolder(). "backup/fridayInv.json");
        $contents = [];

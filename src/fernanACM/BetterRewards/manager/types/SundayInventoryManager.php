...
class SundayInventoryManager extends InventoryManager{

    private const JSON = "backup/sundayInv.json";
    ...
    public static function saveInventory(): void{
        ...
        $menu = SundayInventoryManager::getContents();
        $place = [];

...
class RewardCommand extends BaseCommand{
    ...
    public function __construct(){
        parent::__construct(Loader::getInstance(), "betterrewards", "The best daily and monthly rewards by fernanACM", ["betterewards", "btrewards", "reward"]);
    ...
    public function onRun(CommandSender $sender, string $aliasUsed, array $args): void{
        ...
        RewardForm::getRewardsForm($sender);
